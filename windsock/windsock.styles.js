module.exports = {
  ...
  "bg-yellow-100": {
    backgroundColor: "#fffff050",
  },
  "bg-yellow-200": (env) => ({
    backgroundColor: "#fefcbf" + env.get("backgroundOpacity"),
  }),
  "bg-opacity-5": (env) => env.set("backgroundOpacity", "50"),
  "bg-opacity-10": (env) => env.set("backgroundOpacity", "FF"),
  "bg-yellow-300": {
